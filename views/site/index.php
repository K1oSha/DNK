...
<!--            <img class="d-block w-100" src="/images/DNK.jpg." alt="First slide">-->
<!--        </div>-->
<!--        <div class="carousel-item">-->
<!--            <img class="d-block w-100" src="/images/Безы32131мянный.jpg." alt="Second slide">-->
<!--        </div>-->
<!--        <div class="carousel-item">-->
<!--            <img class="d-block w-100" src="/images/DNK.jpg." alt="Third slide">-->
<!--        </div>-->
<!--    </div>-->
...
<!--    </a>-->
<!--</div>-->
<h1 style="text-align: left">Описание ДНК</h1>
